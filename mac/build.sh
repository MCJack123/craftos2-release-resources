...
if [ "$1" = "setup" ]; then
    ...
    if [[ $GITHUB_REF =~ luajit ]]; then
        ...
        make -C craftos2-lua/src all SYSCFLAGS="-DLUA_USE_MACOSX -mmacosx-version-min=10.15 -target x86_64-apple-macos10.15" SYSLIBS="-lreadline" CC=clang LUA_D="liblua.dylib" DYLD="clang++ -target x86_64-apple-macos10.15 -dynamiclib -fPIC"
    ...
    sqlite3 "/Users/runner/Library/Application Support/com.apple.TCC/TCC.db" "insert into access values ('kTCCServiceAppleEvents', 'com.c-command.DropDMG', 0, 2, 4, 1, NULL, NULL, 0, 'com.apple.finder', NULL, 0, 0, NULL,NULL,'UNUSED',0)"
    sqlite3 "/Users/runner/Library/Application Support/com.apple.TCC/TCC.db" "insert into access values ('kTCCServiceAppleEvents', '/Applications/DropDMG.app/Contents/Frameworks/DropDMGFramework.framework/Versions/A/dropdmg', 1, 2, 4, 1, NULL, NULL, 0, 'com.c-command.DropDMG', NULL, 0, 0, NULL,NULL,'UNUSED',0)"
    sqlite3 "/Users/runner/Library/Application Support/com.apple.TCC/TCC.db" "insert into access values ('kTCCServiceAppleEvents', '$SHELL', 1, 2, 4, 1, NULL, NULL, 0, 'com.c-command.DropDMG', NULL, 0, 0, NULL,NULL,'UNUSED',0)"
    sqlite3 "/Users/runner/Library/Application Support/com.apple.TCC/TCC.db" "insert into access values ('kTCCServiceAppleEvents', '/usr/bin/osascript', 1, 2, 4, 1, NULL, NULL, 0, 'com.c-command.DropDMG', NULL, 0, 0, NULL,NULL,'UNUSED',0)"
